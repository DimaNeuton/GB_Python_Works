...
dict1 = {'A': 1, 'E': 1, 'I': 1, 'O': 1, 'U': 1, 'L': 1, 'N': 1, 'S': 1, 'T': 1, 'R': 1, 'D': 2, 'G': 2,
...
word_cost = 0
for symbol in word.upper(): # переводим все буквы в заглавные
    for key in dict1:
        if key == symbol: word_cost += dict1[key]
print(f'Стомость слова {word} = {word_cost}')
